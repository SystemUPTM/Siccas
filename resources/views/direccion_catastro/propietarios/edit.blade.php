        ...
        <div class="col-md-offset-2 col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    Actualizar datos de {{ $propietario->nombre }}
                    <form class="form-horizontal" method="POST" action="{{ route('propietario.update', ['id' => $propietario->id]) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('rif') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2">
                                    ...
                                    value="{{ $propietario->rif_numero }}"
                                    minlength="1" maxlength="1"
                                    required autofocus>
    
                                    @if ($errors->has('rif_nummero'))
                                        <span class="help-block">
